 ...
 */
class getConsole_SuggestMissingPackageSubscriberService extends Nahati_ContaoIsotopeStockBundle_Tests_Integration_app_AppKernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/framework-bundle/EventListener/SuggestMissingPackageSubscriber.php';
