 ...
 */
class get_Session_DeprecatedService extends Nahati_ContaoIsotopeStockBundle_Tests_Integration_app_AppKernelTestDebugContainer
{
    /**
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/symfony/framework-bundle/Session/DeprecatedSessionFactory.php';
