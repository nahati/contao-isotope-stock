...
class getContao_Image_PictureFactoryService extends Nahati_ContaoIsotopeStockBundle_Tests_Integration_app_AppKernelTestDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/contao/core-bundle/src/Image/PictureFactoryInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/contao/core-bundle/src/Image/PictureFactory.php';
