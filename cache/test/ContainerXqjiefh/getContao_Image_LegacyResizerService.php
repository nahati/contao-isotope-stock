...
class getContao_Image_LegacyResizerService extends Nahati_ContaoIsotopeStockBundle_Tests_Integration_app_AppKernelTestDebugContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).'/vendor/contao/image/src/ResizerInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/contao/image/src/Resizer.php';
        include_once \dirname(__DIR__, 3).'/vendor/contao/image/src/DeferredResizerInterface.php';
        include_once \dirname(__DIR__, 3).'/vendor/contao/image/src/DeferredResizer.php';
        ...
        include_once \dirname(__DIR__, 3).'/vendor/contao/core-bundle/src/Image/LegacyResizer.php';
