 ...
 */
class getContao_Security_AuthenticationProvider_ContaoBackend_TwoFactorDecorator_InnerService extends Nahati_ContaoIsotopeStockBundle_Tests_Integration_app_AppKernelTestDebugContainer
{
    /**
     * Gets the private 'contao.security.authentication_provider.contao_backend.two_factor_decorator.inner' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['contao.security.authentication_provider.contao_backend.two_factor_decorator.inner'])) {
            return $container->privates['contao.security.authentication_provider.contao_backend.two_factor_decorator.inner'];
        }
